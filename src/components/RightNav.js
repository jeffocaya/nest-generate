...
const RightNav = () => {
  return (
    ...
    <button className="border border-black bg-black flex flex-col items-center justify-center p-2">
    ...
    <button className="flex flex-col items-center justify-center p-2 border border-black">
