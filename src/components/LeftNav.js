...
const LeftNav = () => {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`fixed inset-0 w-full h-full bg-primary text-white flex items-center justify-center transform transition-transform duration-500 ${
      ...
      >
        ...
        <div className="text-left">
          ...
          <nav className="font-bold text-3xl md:text-4xl pt-8">
            <ul>
              <li className="mb-4">
